...
const SignIn = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={HandlePostSignup} className="container form-group mt-5 w-75 py-5" style={{ padding: '20px', boxShadow: '0px 0px 5px 5px #999 inset', borderRadius: '20px'}}>
        ...
        <div style={{ height: '2px', color: 'blue', width: '100%', backgroundColor: 'blue' }}></div><br /><br/>
